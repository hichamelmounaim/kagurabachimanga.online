...
const About: React.FC = () => {
    return (
        <div className="max-w-4xl mx-auto px-4 py-16 min-h-screen">
            <SEOHead
                title="About Us - Kagurabachi Manga"
                description="Learn about kagurabachimanga.online — our mission to provide free, high-quality Kagurabachi chapters by Hokazono Takeru, with fast updates and no sign-up."
            ...
            <div className="prose dark:prose-invert max-w-none text-gray-700 dark:text-gray-300 space-y-6">
                <p className="lead text-xl text-gray-600 dark:text-gray-400">
                    Welcome to <strong>Kagurabachi Manga</strong>, the ultimate destination for fans of Takeru Hokazono's masterpiece.
                </p>

                <h2 className="text-2xl font-bold text-gray-900 dark:text-white mt-8 mb-4">Our Mission</h2>
                <p>
                    Our mission is simple: to provide the best possible reading experience for Kagurabachi fans worldwide. We believe that manga should be accessible, fast, and enjoyable to read on any device.
                </p>
                <p>
                ...
                <p>
                    ...
                    <br />
                    Email us at: <a href="mailto:Support@kagurabachimanga.online" className="text-bb-blue hover:underline">Support@kagurabachimanga.online</a>
                </p>

                <div className="bg-gray-100 dark:bg-white/5 p-6 rounded-xl mt-12 border border-gray-200 dark:border-white/10">
                    <p className="text-sm text-gray-500 dark:text-gray-400 italic">
                        <strong>Disclaimer:</strong> This website is a fan project and is not affiliated with Takeru Hokazono, Weekly Shōnen Jump, or their partners. All manga content and characters belong to their respective copyright owners.
                    </p>
                </div>
            </div>
        </div>
